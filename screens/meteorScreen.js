...
import { Text, View, StyleSheet,Alert,SafeAreaView,FlatList,Platform,StatusBar,ImageBackground,Image,Dimensions } from 'react-native';
...
export default class MeteorScreen extends React.Component{
  ...
  getMeteors=()=>{
    axios
    .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=0Qh4NPWo8eTPFGj2aarTcGGvZ9PRyY1mgvyGkAVd")
    .then(response=>{
